...
begin
  ...
  begin
    ...
    Status.Text:='¬ настройках "языки и службы текстового ввода" установите сочетане клавиш <Ctrl>+<Shift>' else
    if hotKeyInd.ItemIndex=2 then
    Status.Text:='¬ настройках "языки и службы текстового ввода" установите сочетане клавиш <Alt>+<Shift>' else
    Status.Text:='';
  end else
  begin
    Status.Text:='';
...
begin
    ...
    if (exKey=1) then Extender.State:=tssOn else
