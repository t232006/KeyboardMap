...
procedure TKeyboardForm.FormHeaderSpeedButton1Click(Sender: TObject);
begin
...
procedure TKeyboardForm.speedWinExecute(Sender: TObject);
begin
...
procedure TKeyboardForm.resetExecute(Sender: TObject);
begin
